1. Given an array of numbers, find the maximum sum of a subsequence with the constraint that numbers in the sequence should be at least k distance apart from each other.
